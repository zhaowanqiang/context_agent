 ...
 * - 公开层（个人网站门面）：首页、/posts、/about、/decider、/guides、/cards、/deals、/on-x、RSS/sitemap/robots
...
export const config = {
  ...
  matcher: [
    "/((?!$|(?:posts|about|decider|guides|cards|deals|on-x)(?:/|$)|opengraph-image|rss\\.xml|sitemap\\.xml|robots\\.txt|api/monitor|api/track|api/checkout|api/webhooks|_next/static|_next/image|favicon\\.ico).*)",
  ],
};
